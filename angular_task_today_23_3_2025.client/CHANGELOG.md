...
- Create Angular project with ng: `ng new angular_task_today_23_3_2025.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angular_task_today_23_3_2025.client.esproj`).
